...
bool SICDisableUnreconginizedMessage = false;

void MCSubtargetInfo::InitMCProcessorInfo(StringRef CPU, StringRef FS) {
  // #if 1 // Disable reconginized processor message. For SIC
  // if (TargetTriple.getArch() == llvm::Triple::sic)
  //   SICDisableUnreconginizedMessage = true;
  // #endif
