//===-- SICMCCodeEmitter.h - Convert SIC Code to Machine Code -----------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the SICMCCodeEmitter class.
//
//===----------------------------------------------------------------------===//
//

#ifndef LLVM_LIB_TARGET_SIC_MCTARGETDESC_SICMCCODEEMITTER_H
#define LLVM_LIB_TARGET_SIC_MCTARGETDESC_SICMCCODEEMITTER_H
...
class SICMCCodeEmitter : public MCCodeEmitter {
  SICMCCodeEmitter(const SICMCCodeEmitter &) = delete;
  void operator=(const SICMCCodeEmitter &) = delete;
  const MCInstrInfo &MCII;
  MCContext &Ctx;
  bool IsLittleEndian;

public:
  SICMCCodeEmitter(const MCInstrInfo &mcii, MCContext &Ctx_, bool IsLittle)
      : MCII(mcii), Ctx(Ctx_), IsLittleEndian(IsLittle) {}

  ~SICMCCodeEmitter() override {}
