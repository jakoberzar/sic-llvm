...
IntegerType *Type::getInt24Ty(LLVMContext &C) { return &C.pImpl->Int24Ty; }
...
PointerType *Type::getInt24PtrTy(LLVMContext &C, unsigned AS) {
  return getInt24Ty(C)->getPointerTo(AS);
}
...
IntegerType *IntegerType::get(LLVMContext &C, unsigned NumBits) {
  ...
  case  24: return cast<IntegerType>(Type::getInt24Ty(C));
