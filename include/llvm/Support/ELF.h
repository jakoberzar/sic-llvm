...
// SIC Specific e_flags
enum {
  EF_SIC_NOREORDER = 0x00000001, // Don't reorder instructions
  EF_SIC_PIC       = 0x00000002, // Position independent code
  EF_SIC_ARCH_32   = 0x50000000, // SIC32 instruction set per linux not elf.h
  EF_SIC_ARCH      = 0xf0000000  // Mask for applying EF_SIC_ARCH_ variant
};

// ELF Relocation types for Mips (SIC)
enum {
#include "ELFRelocs/SIC.def"
};
